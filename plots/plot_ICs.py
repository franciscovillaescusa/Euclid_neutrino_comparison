...
ax1.set_ylabel(r'$P_{\rm sim}(k)/P_{\rm linear}(k)$',fontsize=18)
ax1.set_xlim([x_min,x_max])
ax1.set_ylim([y_min,y_max])


f_out='Pk_ratio_ICs.pdf'


######### REPS 512 ############
f1 = '../Analysis/Pk_ICs_0.0eV.txt'
f2 = '../Analysis/Pk_binned_CAMB_512_z=127.txt'
...
p1,=ax1.plot(k1,Pk1/Pk2,linestyle='-',marker='None',c='r')
...
ax1.set_title(r'${\rm ICs}\,\,z=127$',position=(0.5,1.02),size=18)
